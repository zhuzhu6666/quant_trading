...
- 状态：`active`（滞留已止；04:53/05:23 UTC 两轮同 workload 验证：post-redundancy RSS 1013→272/336MB，0 ERROR/NRestarts=0，周期~150s；in-scan HWM 增量仍 ~380-466MB 未达 300MB 线；24h 棘轮待观察）
