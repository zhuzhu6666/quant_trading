...
- 当前：新五工作区和直接废弃路由已经落在 React 19 + Vite；Workbench Shell、Safety
  ...
  已补齐 `market.bars.v1`，缺数据明确返回 unknown。2026-08-13 新 static artifact
  已切换到公网 Caddy 根目录，API 合同补丁已部署并重启验证，旧 dist 和 API pre-change
