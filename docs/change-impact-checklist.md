...
| Safety shadow evidence | 是否只在 full cycle 追加 fsync observation；记录是否不含账户凭据/金额等无关敏感事实；遥测失败是否不改写 broker action；24 小时/完整 lifecycle gate 是否验证 continuity、fresh reconcile、unknown=0、independent exact match、duplicate/conflict/forced-shadow 为零 |
