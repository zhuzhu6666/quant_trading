...
> 当前状态（2026-06-25）: 本文是升级蓝图和历史审计材料。Phase 0-7 主体已完成，当前执行/前端口径以 `CLAUDE.md`、`TODO.md`、`docs/startup.md`、`miniprogram_v2/README.md` 为准。文中的 MT5、`frontend-v2`、`start-all.py` 描述多为历史迁移背景，不再是当前开发入口。
