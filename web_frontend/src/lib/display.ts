const DISPLAY_TRANSLATIONS: Record<string, string> = {
  ...
  no_new_risk_latched: "不新增风险锁存",
  accepting_new_risk_false: "循环未允许新增风险",
  generation_not_accepting_new_risk: "当前代际未允许新增风险",
  process_shutdown_requested: "进程正在退出",
  loop_stop_requested: "循环正在停止",
  session_state_unavailable: "交易时段状态不可用",
  session_circuit_breaker: "交易时段熔断",
  safety_freshness_stale: "安全事实过期",
  safety_freshness_unknown: "安全事实未知",
  safety_heartbeat_stale: "安全心跳过期",
  account_freshness_stale: "账户事实过期",
  account_freshness_unknown: "账户事实未知",
  account_reconcile_stale: "账户对账过期",
  positions_freshness_stale: "持仓事实过期",
  positions_freshness_unknown: "持仓事实未知",
  positions_reconcile_stale: "持仓对账过期",
  canonical_forward_var_not_ready: "前瞻风险指标未就绪",
  safety: "Safety 闸门",
  live_loop: "Live Loop",
  open_admission: "开仓准入",
  "safety+live_loop": "Safety 闸门 + Live Loop",
  thesis: "交易假设",
