...
assert.match(liveHook, /endpointFallback:\s*3_000/);
assert.match(liveHook, /endpointVerification:\s*10_000/);
assert.match(liveHook, /export function liveEndpointPollInterval\(connected: boolean\)/);
...
assert.match(overview, /const liveEndpointInterval = liveEndpointPollInterval\(connected\)/);
assert.match(overview, /queryKey: queryKeys\.loopStatus[\s\S]*?refetchInterval: liveEndpointInterval/);
assert.match(overview, /queryKey: queryKeys\.account[\s\S]*?refetchInterval: liveEndpointInterval/);
assert.match(trading, /const liveEndpointInterval = liveEndpointPollInterval\(connected\)/);
assert.match(trading, /queryKey: queryKeys\.positions[\s\S]*?refetchInterval: liveEndpointInterval/);
assert.match(trading, /queryKey: queryKeys\.liveStatus[\s\S]*?refetchInterval: liveEndpointInterval/);
