...
def test_prepared_discovered_gp_candidate_reaches_preflight_and_activation(monkeypatch):
    ...
    catalog = [{
        ...
        "runtime_selection_fingerprint": "b" * 64,
        "lifecycle_config_hash": "c" * 64,
        "lifecycle_mutation_id": "mutation:prepared",
        "loaded_projection": {
            "loaded": True,
            "status": "loaded",
            "generation": 1,
        ...
        "lifecycle_evidence": {
            ...
            "v16": {"command_id": "v16cmd_test", "candidate_id": factor_id},
        },
        "source": "discovered",
        "role": "alpha",
        "direction": 1,
    ...
    assert lifecycle_options == [{"health_stale_after_sec": 3600.0}]
